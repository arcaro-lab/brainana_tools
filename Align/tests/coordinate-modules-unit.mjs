...
assert.match(projection, /export function clientPointToImageOnCurrentSlice/)
assert.match(projection, /const determinant = ax \* by - ay \* bx/)
assert.match(projection, /return canvasPointToImageOnCurrentSlice\(view, canvasX, canvasY\)/)
assert.match(projection, /Orthographic projection is the authoritative/)
